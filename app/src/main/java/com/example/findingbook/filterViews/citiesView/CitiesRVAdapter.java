...
public class CitiesRVAdapter extends RecyclerView.Adapter<CitiesRVAdapter.ViewHolder> {
    ...
    CitiesRVAdapter(Context context, List<String> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.rvcities_row, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            myTextView = itemView.findViewById(R.id.singleCity);
